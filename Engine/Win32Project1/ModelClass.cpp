...
HRESULT ModelClass::InitializeVertexBuffer(ID3D11Device* dev, ID3D11DeviceContext* devcon, LogManager* logger)
{
	Vertex triVerts[] =
	{
		{ D3DXVECTOR3(-1, -1, 1.0f), D3DXCOLOR(1.0f, 0.0f, 0.0f, 1.0f) },
		{ D3DXVECTOR3(0, 1, 1.0f), D3DXCOLOR(0.0f, 1.0f, 0.0f, 1.0f) },
		{ D3DXVECTOR3(1, -1, 1.0f), D3DXCOLOR(0.0f, 1.0f, 1.0f, 1.0f) }
	};
